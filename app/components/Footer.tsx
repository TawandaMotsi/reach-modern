        ...
        <div style={{ maxWidth: 1160, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: 16, marginBottom: 48 }}>
            {[
              ...
              { label: "Instagram", href: "https://www.instagram.com/reachhcs?utm_source=qr&igsh=dGdjcXVsdjN1MTFy", svg: <img src={getImagePath("/instagram.svg")} alt="" width="18" height="18" /> },
