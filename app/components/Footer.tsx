        ...
        <div style={{ maxWidth: 1160, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: 16, marginBottom: 48 }}>
            {[
              ...
              { label: "Instagram", href: "https://www.instagram.com/reachhcs?utm_source=qr&igsh=dGdjcXVsdjN1MTFy", svg: <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg> },
