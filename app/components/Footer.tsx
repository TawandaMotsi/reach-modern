        ...
        <div style={{ maxWidth: 1160, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: 16, marginBottom: 48 }}>
            {[
              ...
              { label: "Instagram", href: "https://www.instagram.com/reachhcs", svg: <img src={getImagePath("/instagram.svg")} alt="" width="18" height="18" /> },
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 40, marginBottom: 48 }}>
            ...
            <div>
              ...
              <div style={{ color: "rgba(255,255,255,0.65)", fontSize: "0.875rem", lineHeight: 2 }}>
                ...
                <p>E: <a href="mailto:infor@reach-healthcare.com" style={{ color: "rgba(255,255,255,0.8)", textDecoration: "none" }}>infor@reach-healthcare.com</a></p>
