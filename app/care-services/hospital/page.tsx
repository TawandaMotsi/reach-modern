...
export default function HospitalToHomePage() {
  const services = [
    { icon: "🏥", title: "Hospital Discharge", desc: "Smooth transition from hospital to home with professional support" },
    { icon: "💊", title: "Medication Management", desc: "Ensuring medications are taken correctly and on time" },
    { icon: "🩺", title: "Recovery Support", desc: "Assistance with rehabilitation and recovery exercises" },
    { icon: "🍽️", title: "Nutritional Care", desc: "Meal preparation to support healing and recovery" },
    { icon: "🛏️", title: "Personal Care", desc: "Help with bathing, dressing, and daily activities" },
    { icon: "📞", title: "Family Liaison", desc: "Regular updates to family members on progress" },
  ];
    ...
    <main style={{ fontFamily: "'Georgia', 'Times New Roman', serif", background: "#faf9f7", color: "#2c2c2c", overflowX: "hidden" }}>
      ...
      <section style={{ position: "relative", minHeight: "420px", display: "flex", alignItems: "center", justifyContent: "center", textAlign: "center", background: "linear-gradient(135deg, #0a4d7c 0%, #0984e3 60%, #38b6ff 100%)", padding: "100px 24px 80px", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 760, position: "relative", zIndex: 1 }}>
          <h1 style={{ fontSize: "clamp(2rem, 5vw, 3.4rem)", fontWeight: 700, color: "#ffffff", lineHeight: 1.2, marginBottom: 24 }}>Hospital to Home</h1>
          <p style={{ fontSize: "clamp(1rem, 2vw, 1.15rem)", color: "rgba(255,255,255,0.88)", lineHeight: 1.75, maxWidth: 640, margin: "0 auto 32px" }}>
            One of the leading causes of hospital readmission or slow post-hospitalisation recovery is inadequate support at home. We provide comprehensive care to ensure a smooth transition.
          </p>
      ...
      <section style={{ background: "#f0f7ff", padding: "80px 24px" }}>
        <div style={{ maxWidth: 1160, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 56, alignItems: "center" }}>
          <FadeIn>
            <div>
              <h2 style={{ fontSize: "clamp(1.4rem, 2.8vw, 2rem)", fontWeight: 700, color: "#0a4d7c", marginBottom: 20, lineHeight: 1.3 }}>Supporting Your Recovery at Home</h2>
              <p style={{ lineHeight: 1.85, color: "#444", marginBottom: 16 }}>
                Returning home after a hospital stay can be challenging. Our hospital to home service ensures you have the support you need during this critical recovery period.
              </p>
              <p style={{ lineHeight: 1.85, color: "#444" }}>
                We work closely with hospital discharge teams to create a seamless transition, providing care that helps prevent readmission and promotes faster recovery.
              </p>
            </div>
          </FadeIn>
          <FadeIn delay={150}>
            <div style={{ borderRadius: 16, overflow: "hidden", boxShadow: "0 20px 60px rgba(0,0,0,0.1)" }}>
              <img src={getImagePath("/images/iStock-477715817.jpg")} alt="Hospital to Home" style={{ width: "100%", display: "block", objectFit: "cover" }} />
            </div>
          </FadeIn>
        </div>
      </section>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <FadeIn>
            <div style={{ textAlign: "center", marginBottom: 52 }}>
              <h2 style={{ fontSize: "clamp(1.6rem, 3vw, 2.2rem)", fontWeight: 700, color: "#0a4d7c", marginBottom: 12 }}>Our Hospital to Home Services</h2>
              <p style={{ color: "#666", maxWidth: 580, margin: "0 auto", lineHeight: 1.65 }}>Comprehensive support for a smooth recovery</p>
            </div>
          </FadeIn>
      ...
      <section style={{ background: "linear-gradient(135deg, #083a5e 0%, #0984e3 100%)", padding: "80px 24px", textAlign: "center" }}>
        <FadeIn>
          <h2 style={{ fontSize: "clamp(1.6rem, 3vw, 2.2rem)", color: "#fff", fontWeight: 700, marginBottom: 14 }}>Plan Your Hospital Discharge</h2>
          <p style={{ color: "rgba(255,255,255,0.75)", maxWidth: 480, margin: "0 auto 36px", lineHeight: 1.65 }}>Contact us to arrange support for your return home from hospital.</p>
