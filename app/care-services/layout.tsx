...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Care Services | Reach Healthcare Solutions", description: "Specialist home care services including domiciliary, live-in, respite, end-of-life, hospital, and children's care across the UK.", url: "https://www.reachhealthcaresolutions.co.uk/care-services" },
};
